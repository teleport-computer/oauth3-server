...
<h2>2. The enclave</h2>
<p>It runs as a dstack app on Phala (app id <code>915c8197…cae8</code>) inside a Trusted Execution Environment. Attestation / measurement: <a href="${attest}">${esc(attest)}</a>. <span class="stamp ${attested ? "ok" : ""}">${attested ? "attested" : "dev"}</span></p>
